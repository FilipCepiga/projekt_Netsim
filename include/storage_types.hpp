...
#ifndef PROJEKT_NETSIM_STORAGE_TYPES_H
#define PROJEKT_NETSIM_STORAGE_TYPES_H
...
public:
    ...
    virtual std::size_t size() const = 0; // metoda size()
    virtual bool empty() const = 0; // metoda empty()

    // metody pozwalające na uzyskanie dostępu “tylko do odczytu” do kontenera przechowującego półprodukty
...
#endif //PROJEKT_NETSIM_STORAGE_TYPES_H
